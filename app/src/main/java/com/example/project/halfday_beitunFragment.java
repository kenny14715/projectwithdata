...
public class halfday_beitunFragment extends Fragment {

    public halfday_beitunFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        AppCompatTextView tourselect;
        tourselect = view.findViewById(R.id.tourselect);
        tourselect.setText("Half Day Tour\nTime:4 hours");
